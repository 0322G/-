    ...
    <el-row :gutter="20" class="el-row">
        ...
        <el-col :span="5" :offset="3">
            <el-card class="box-card">
                ...
                <h3> {{ store.state.adminInfo.name }}</h3>
                <h3> {{ store.state.adminInfo.id }}</h3>
            </el-card>
        </el-col>
        ...
        <el-col :span="9" :offset="1">
            <!-- 修改个人信息窗口 -->
            <el-card v-if="!store.state.isPassword">
                <template #header>
                    <span>个人信息</span>
                </template>
                ...
                <el-form ref="userFormRef" :model="userForm" :rules="userFormRules" label-width="80px"
                    ...
                    <el-form-item label="头像" prop="avatar" style="width:70%">
            ...
            <el-card v-else>
                ...
                <el-form ref="passwordFormRef" :model="passwordForm" :rules="passwordFormRules" label-width="120px"
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="submitPwForm()">提交</el-button>
...
//导入个人信息
const { password, name, phone, avatar } = store.state.adminInfo
// 引入头像路径
const avatarUrl = computed(() => store.state.adminInfo.avatar ? 'http://localhost:3000' + store.state.adminInfo.avatar : 'https://cube.elemecdn.com/3/7c/3ea6beec64369c2642b92c6726f1epng.png')
